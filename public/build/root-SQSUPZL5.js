import {
  ...
  useCatch,
  useMatches
} from "/build/_shared/chunk-OX7A7OC4.js";
import {
  __toModule,
  init_react,
  require_react
...
// browser-route-module:/Users/danielskroski/Documents/remix-pokemon/app/root.tsx?browser
init_react();
...
var tailwind_default = "/build/_assets/tailwind-5DXQKD3T.css";
...
function App() {
  return /* @__PURE__ */ React232.createElement(Document, null, /* @__PURE__ */ React232.createElement(Layout, null, /* @__PURE__ */ React232.createElement(import_react_router_dom.Outlet, null)));
}
function Document({
  children,
  title
}) {
  return /* @__PURE__ */ React232.createElement("html", {
    lang: "en"
  }, /* @__PURE__ */ React232.createElement("head", null, /* @__PURE__ */ React232.createElement("meta", {
    charSet: "utf-8"
  }), /* @__PURE__ */ React232.createElement("meta", {
    name: "viewport",
    content: "width=device-width,initial-scale=1"
  }), title ? /* @__PURE__ */ React232.createElement("title", null, title) : null, /* @__PURE__ */ React232.createElement(Meta, null), /* @__PURE__ */ React232.createElement(Links, null)), /* @__PURE__ */ React232.createElement("body", null, children, /* @__PURE__ */ React232.createElement(RouteChangeAnnouncement, null), /* @__PURE__ */ React232.createElement(ScrollRestoration, null), /* @__PURE__ */ React232.createElement(Scripts, null), /* @__PURE__ */ React232.createElement(LiveReload, null)));
}
function Layout({ children }) {
  ...
  }, /* @__PURE__ */ React232.createElement("div", null, /* @__PURE__ */ React232.createElement("div", null, /* @__PURE__ */ React232.createElement("nav", {
    className: "sm:hidden",
    "aria-label": "Back"
  }, /* @__PURE__ */ React232.createElement(Link, {
    to: "/",
    className: "flex items-center text-sm font-medium text-gray-400 hover:text-gray-200"
  }, /* @__PURE__ */ React232.createElement(ChevronLeftIcon_default, {
    className: "flex-shrink-0 -ml-1 mr-1 h-5 w-5 text-gray-500",
    "aria-hidden": "true"
  }), "Back")), /* @__PURE__ */ React232.createElement("nav", {
    className: "hidden sm:flex",
    "aria-label": "Breadcrumb"
  }, /* @__PURE__ */ React232.createElement("ol", {
    role: "list",
    className: "flex items-center space-x-4"
  }, /* @__PURE__ */ React232.createElement("li", null, /* @__PURE__ */ React232.createElement("div", {
    className: "flex"
  }, /* @__PURE__ */ React232.createElement(Link, {
    to: "/",
    className: "text-sm font-medium text-gray-400 hover:text-gray-200"
  }, "Home"))), matches.filter((match) => match.handle && match.handle.breadcrumb).map((match, index) => /* @__PURE__ */ React232.createElement("li", {
    key: index
  }, /* @__PURE__ */ React232.createElement("div", {
    className: "flex"
  }, match.handle.breadcrumb(match.params))))))), /* @__PURE__ */ React232.createElement("div", {
    className: "mt-2 md:flex md:items-center md:justify-between"
  }, /* @__PURE__ */ React232.createElement("div", {
    className: "flex-1 min-w-0"
  }, /* @__PURE__ */ React232.createElement("h2", {
    className: "text-2xl font-bold leading-7 text-black sm:text-3xl sm:truncate"
  }, (_c = (_b = (_a = lastMatch == null ? void 0 : lastMatch.handle) == null ? void 0 : _a.title) == null ? void 0 : _b.call(_a, lastMatch.params)) != null ? _c : "Pokemon")))), /* @__PURE__ */ React232.createElement("div", {
    className: "p-5"
  }, /* @__PURE__ */ React232.createElement("div", null, children)));
}
function CatchBoundary() {
  ...
  switch (caught.status) {
    case 401:
      message = /* @__PURE__ */ React232.createElement("p", null, "Oops! Looks like you tried to visit a page that you do not have access to.");
      break;
    case 404:
      message = /* @__PURE__ */ React232.createElement("p", null, "Oops! Looks like you tried to visit a page that does not exist.");
      break;
    default:
      throw new Error(caught.data || caught.statusText);
  }
  return /* @__PURE__ */ React232.createElement(Document, {
    title: `${caught.status} ${caught.statusText}`
  }, /* @__PURE__ */ React232.createElement(Layout, null, /* @__PURE__ */ React232.createElement("h1", null, caught.status, ": ", caught.statusText), message));
}
function ErrorBoundary({ error }) {
  console.error(error);
  return /* @__PURE__ */ React232.createElement(Document, {
    title: "Error!"
  }, /* @__PURE__ */ React232.createElement(Layout, null, /* @__PURE__ */ React232.createElement("div", null, /* @__PURE__ */ React232.createElement("h1", null, "There was an error"), /* @__PURE__ */ React232.createElement("p", null, error.message), /* @__PURE__ */ React232.createElement("hr", null), /* @__PURE__ */ React232.createElement("p", null, "Hey, developer, you should replace this with what you want your users to see."))));
}
var RouteChangeAnnouncement = React232.memo(() => {
  let [hydrated, setHydrated] = React232.useState(false);
  let [innerHtml, setInnerHtml] = React232.useState("");
  let location = (0, import_react_router_dom.useLocation)();
  React232.useEffect(() => {
    setHydrated(true);
  }, []);
  let firstRenderRef = React232.useRef(true);
  React232.useEffect(() => {
...
//# sourceMappingURL=/build/root-SQSUPZL5.js.map
